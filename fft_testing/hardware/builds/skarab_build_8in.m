function skarab_build_8in(fileID, design, clk)
    new_path = sprintf('/media/morag/linux_storage/storage_home/university/test_system/fft_testing/hardware/builds/designs/8in/skarab/generated/%s_%smhz', design, clk);
    ...
    load_system(design)
    set_param(sprintf('%s/SKARAB', design), 'clk_rate', clk)
