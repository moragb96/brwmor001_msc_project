function au50_build_4in(fileID, design, clk)
    new_path = sprintf('/media/morag/linux_storage/storage_home/university/test_system/fft_testing/hardware/builds/designs/4in/skarab/generated/%s_%smhz', design, clk);
